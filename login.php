...
<body class="bg-dark">
    ...
    <div class="container d-flex align-items-center justify-content-center">
        <div class="card bg-dark" style="width: 18rem;">
            ...
            <div class="card-body">
                <div class="alert alert-danger"> <?= session('error') != false ? session('error') : 'Bilgilerinizi girin' ?>
                    <!--  bu işaret echo görevi görür < ? = -->
                </div>
                <form action="islem.php?islem=giris" method="post">
                    <!-- islem.php'ye post ile gönderdim ancak url çubuğunda da islem=giris yazmasını istedim böylece yapılan işlemin ne olduğu eblli olsun yani hem post hem get değeri göndermiş olduk Burada dikkat edilmesi gereken olay get değerine islem adında bir değişken gönderdim ve değeri giris -->
                    ...
                    <label for="password" class="text-success" value="<?= $_SESSION['password']; ?>">Şifreniz</label>
...
<!-- Sayfa yenilenince error değikeninin değerini buna atıyorum ki tekerar login butonuna basılana bu şekilde gözüksün -->
<?php
$_SESSION['error'] = "Bilgilerinizi girin";
